    ...
    <footer className="page__footer footer">
      <div className="footer__wrapper">
        <div className="footer__company">
          <img className="footer__company-logo" src="../img/logo.png" alt="" />

          <p className="footer__company-info">150015, г. Москва, ул. Московская, д. 32</p>
          <p className="footer__company-info">Генеральная лицензия Банка России №1050</p>
          <p className="footer__company-info">Ⓒ Лига Банк, 2019</p>
        </div>
        
        <ul className="footer__list">
          <li className="footer__item">
            <a className="footer__link" href="/services">Услуги</a>
          </li>
          <li className="footer__item">
            <a className="footer__link" href="/calc-credit">Рассчитать кредит</a>
          </li>
          <li className="footer__item">
            <a className="footer__link" href="/contacts">Контакты</a>
          </li>
          <li className="footer__item">
            <a className="footer__link" href="/questions">Задать вопрос</a>
          </li>
        </ul>

        <div className="footer__phone footer__phone-operator">
          <h2 className="footer__phone-header">*0904</h2>
          <p className="footer__phone-text">Бесплатно для абонентов МТС, Билайн, Мегафон, Теле2</p>
        </div>

        <div className="footer__phone footer__phone-country">
          <h2 className="footer__phone-header">8 800 111 22 33</h2>
          <p className="footer__phone-text">Бесплатный для всех городов России</p>
        </div>
